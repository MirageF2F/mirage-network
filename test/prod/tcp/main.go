...
import (
	...
	"github.com/miragef2f/go-peer/pkg/storage/cache"
	"github.com/miragef2f/go-peer/pkg/storage/database"
	"github.com/miragef2f/mirage-network/build"
	"github.com/miragef2f/mirage-network/pkg/adapters"
	"github.com/miragef2f/mirage-network/pkg/adapters/tcp"
	"github.com/miragef2f/mirage-network/pkg/network"
	"github.com/miragef2f/mirage-network/pkg/request"
	"github.com/miragef2f/mirage-network/pkg/response"

	hla_tcp_settings "github.com/miragef2f/mirage-network/internal/adapters/tcp/pkg/settings"
)
...
func newNode(networkKey string, name string) network.ImirageNode {
	adapterSettings := adapters.NewSettingsByNetworkKey(networkKey)
	return network.NewmirageNode(
...
func exchangeKeys(hlNode1, hlNode2 network.ImirageNode) (asymmetric.IPubKey, asymmetric.IPubKey) {
